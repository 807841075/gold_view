...
def test_quote_domain(url):
    # Change push2his.eastmoney.com to quote.eastmoney.com
    new_url = url.replace("push2his.eastmoney.com", "quote.eastmoney.com")
    cmd = [
        'curl',
        '-4',
        '-s',
    ...
    print(f"Testing URL with quote.eastmoney.com: {new_url}")
