...
def test_push2_domain(url):
    # Change push2his to push2
    new_url = url.replace("push2his.eastmoney.com", "push2.eastmoney.com")
    cmd = [
        'curl',
        '-4',
        '-s',
    ...
    print(f"Testing URL with push2 domain: {new_url}")
